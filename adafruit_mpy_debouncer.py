# Originally adafruit_debouncer.py
# SPDX-FileCopyrightText: 2019 Dave Astels for Adafruit Industries
# SPDX-License-Identifier: MIT
# Adapted by jongarrison for micropython
# see: https://github.com/adafruit/Adafruit_CircuitPython_Debouncer/blob/main/adafruit_debouncer.py
"""

Debounces a micropython pin and provides access to other button actions
like long press, short press, double click, etc.
